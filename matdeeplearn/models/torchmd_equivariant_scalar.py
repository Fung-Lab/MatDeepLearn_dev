...
@registry.register_model("torchmd_equivariant_scalar")


class TorchMD_EquivariantScalar(BaseModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TorchMD_EquivariantScalar, self).__init__(**kwargs)
        ...
        self.out_model = EquivariantScalar(hidden_channels, activation=activation, allow_prior_model=False)
    ...
    def _forward(self, data):
        ...
        x = self.out_model.pre_reduce(x, vec, data.z, data.pos, data.batch)
        ...
        # aggregate atoms
        x = self.out_model.reduce(x, data.batch)
        ...
        x = self.out_model.post_reduce(x)
