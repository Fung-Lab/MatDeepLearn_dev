...
from matdeeplearn.models.in_progress.scn.smearing import GaussianSmearing
...
@registry.register_model("equiformer_v2_ft")
class EquiformerV2_OC20(BaseModel):
    ...
    def forward(self, data):
        ...
        for i in range(self.num_resolutions):
            self.SO3_rotation_rn[i].set_wigner(edge_rot_mat)
