...
@registry.register_model("gate_torchmd_etEarly")


class GatedTorchMD_ET_Early(BaseModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(GatedTorchMD_ET_Early, self).__init__(**kwargs)
        ...
        for _ in range(num_layers):
            layer = GatedEquivariantMultiHeadAttention(
                hidden_channels,
                num_rbf,
                distance_influence,
                num_heads,
...
class GatedEquivariantMultiHeadAttention(MessagePassing):
    def __init__(
        self,
        hidden_channels,
        num_rbf,
        ...
        super(GatedEquivariantMultiHeadAttention, self).__init__(aggr=aggregation, node_dim=0)
